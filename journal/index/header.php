...
<div class="container">
 ...
 <!--nav-top start-->
<nav class="navbar-sm navbar-expand bg-dark navbar-dark">
...
<img src="http://localhost/needyamin/assets/img/logo.png" alt="" style="max-width:120px;">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="font-size: 15px;">
          <a class="dropdown-item" href="category.php?category=Article">Article</a>
          <a class="dropdown-item" href="category.php?category=other">other</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">More Options</a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-1 d-md-none d-sm-block" type="search" placeholder="Search" aria-label="Search">
      <button class="btn btn-outline my-1 my-sm-0 d-md-none d-sm-block" type="submit"> <i class="fa fa-search"></i></button>
    </form>
  </div>
</nav>
